...
public class additemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://inventory-a1b50-default-rtdb.firebaseio.com").getReference("Users");
        databaseReferencecat = FirebaseDatabase.getInstance("https://inventory-a1b50-default-rtdb.firebaseio.com").getReference("Users");
